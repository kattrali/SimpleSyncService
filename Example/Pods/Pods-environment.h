...
// SimpleSyncService
#define COCOAPODS_POD_AVAILABLE_SimpleSyncService
#define COCOAPODS_VERSION_MAJOR_SimpleSyncService 1
#define COCOAPODS_VERSION_MINOR_SimpleSyncService 2
#define COCOAPODS_VERSION_PATCH_SimpleSyncService 2
